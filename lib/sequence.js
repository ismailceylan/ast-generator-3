...
export default class Sequence
{
	...
	/**
	 * The conditional sequences associated with the sequence.
	 * 
	 * @type {Sequence[]}
	 */
	...
	/**
	 * Sets the sequences to be executed if the given conditional is
	 * met after for the current sequence.
	 *
	 * @param {Sequence[]} sequences - The sequences to be executed.
	 * @returns {this}
	 */
	then( sequences )
	{
		this.conditionalSequences = sequences;
		return this;
	}
}
